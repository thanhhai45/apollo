Trestle.configure do |config|
  ...
  #
  config.site_title = "Techapollo Admin"
  ...
  #
  config.footer = "Powered by Techapollo"
  ...
  config.tinymce.default.configure do |c|
    ...
    c.toolbar = [
      ...
      "bullist numlist | indent outdent | undo redo | link unlink | image charmap table | code | imagetools"
    ]
